...
//     final transforms = <MoveTransform>[];
//
...
//
//         transforms.add(MoveTransform(Position(rowOnlyNotNull[0].index.toDouble(), y), Position(0, y), value));
//         transforms.add(MoveTransform(Position(rowOnlyNotNull[1].index.toDouble(), y), Position(0, y), value));
//         continue;
//       }
//
//       final twoDiffValues =
...
//
//         transforms.add(MoveTransform(Position(rowOnlyNotNull[0].index.toDouble(), y), Position(0, y), leftValue));
//         transforms.add(MoveTransform(Position(rowOnlyNotNull[1].index.toDouble(), y), Position(1, y), rightValue));
//         continue;
//       }
//
//       bool merged = false;
...
//     }
//
//     final newBoard = Board.fromBoardItems(newItems);
//
...
//   final List<MoveTransform> transforms;
...
// }
//
// class MoveTransform extends Equatable {
//   final Position from;
//   final Position to;
//   final int value;
//
//   const MoveTransform(this.from, this.to, this.value);
//
//   @override
